...
if (!$producto) {
    header("Location: " . URL_BASE . "/admin/views/productos.php");
    exit();
}
?>
...
<div class="container mt-5">
    ...
    <a href="<?= URL_BASE ?>/admin/views/productos.php" class="btn btn-secondary mb-3">
    <i class="bi bi-arrow-left"></i> Volver</a>

    <div class="card p-4 shadow-sm">
        <form action="<?= URL_BASE ?>/admin/controllers/productos_actualizar.php" method="POST" class="row g-3">
            ...
            <div class="col-12">
                ...
                <a href="<?= URL_BASE ?>/admin/views/productos.php" class="btn btn-danger ms-2"><i class="bi bi-x-lg"></i> Cancelar</a>
            </div>
        </form>
    </div>
</div>
